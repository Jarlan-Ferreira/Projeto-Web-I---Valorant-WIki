...
// Requisito 3: Função de busca que consulta dados locais do Valorant
// Função assíncrona para carregar dados locais
        ...
        const agentCard = `
            <div class="col-md-6 col-lg-4 mx-auto">
                <div class="card agent-card position-relative" onclick="viewAgentDetails('${agent.uuid}')">
                    <!-- Requisito 5: Imagem do agente com fallback -->
                    <img src="../images/agents/${agent.displayName.toLowerCase().replace(/[^a-z0-9]/g, '')}-icon.png" class="agent-image" alt="${agent.displayName}" onerror="this.src='../images/default-agent.png'">
